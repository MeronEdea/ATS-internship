...
<body>
    ...
    <script>
        document.querySelector('input[name="date"]').type = 'text';
        document.querySelector('input[name="start_time"]').type = 'text';
        document.querySelector('input[name="end_time"]').type = 'text';
    </script>
</body>
</html>